...
MQTT.prototype.initMQTTClient = function () {
    ...
    self.client.onLog(function (msg) {
        self.log(msg.toString());
    });
...
MQTT.prototype.createTopic = function (pattern, device) {
    ...
    //self.log("+++++++++++++++++ "+JSON.stringify(self.controller));
    self.log("+++++++++++++++++ " + JSON.stringify(self.controller.config));
    if (device != undefined) {
